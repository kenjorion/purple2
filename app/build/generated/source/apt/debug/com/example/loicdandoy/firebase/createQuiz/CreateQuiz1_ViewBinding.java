...
public class CreateQuiz1_ViewBinding implements Unbinder {
  private CreateQuiz1 target;

  private View view2131296303;

  @UiThread
  public CreateQuiz1_ViewBinding(CreateQuiz1 target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreateQuiz1_ViewBinding(final CreateQuiz1 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CreateQuiz1 target = this.target;
