...
public class CreateQuiz2_ViewBinding implements Unbinder {
  private CreateQuiz2 target;

  private View view2131296303;

  @UiThread
  public CreateQuiz2_ViewBinding(CreateQuiz2 target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreateQuiz2_ViewBinding(final CreateQuiz2 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CreateQuiz2 target = this.target;
