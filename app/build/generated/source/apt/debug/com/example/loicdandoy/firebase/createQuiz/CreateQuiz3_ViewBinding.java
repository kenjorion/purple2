...
public class CreateQuiz3_ViewBinding implements Unbinder {
  private CreateQuiz3 target;

  private View view2131296303;

  @UiThread
  public CreateQuiz3_ViewBinding(CreateQuiz3 target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CreateQuiz3_ViewBinding(final CreateQuiz3 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CreateQuiz3 target = this.target;
